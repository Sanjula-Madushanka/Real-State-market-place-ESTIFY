...
import { FiShare2, FiArrowLeft, FiMessageSquare, FiMail, FiDownload } from 'react-icons/fi';
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredBookings.map((booking) => (
                  <tr key={booking._id} className="hover:bg-gray-50">
                      ...
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10">
                          {booking.property?.images?.[0] ? (
                            <img className="h-10 w-10 rounded-full object-cover" src={booking.property.images[0]} alt="Property" />
                          ) : (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{booking.user?.username || 'N/A'}</div>
